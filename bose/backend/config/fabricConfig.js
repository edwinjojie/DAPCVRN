...
export default {
  ...
  // Wallet stored in blockchain-services/wallet
  walletPath: path.resolve(projectRoot, 'blockchain-services', 'wallet'),
  // CCP path in blockchain-services/fabric-samples/...
